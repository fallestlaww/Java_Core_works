...
public class Main {
	...
	public static void main(String[] args) {
		...
		List<Month> massive = Arrays.asList(Month.values());
		List<Seasons> massives = Arrays.asList(Seasons.values());
		...
		case "6": {
				...
				if(flag) {
					...
					if(ordinal == (massives.size() -1)) {
						ordinal = 0;
						System.out.println(massives.get(ordinal));
					}else {
						System.out.println(massives.get((ordinal)+1));
					}
				}
